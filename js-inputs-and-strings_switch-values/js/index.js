...
- [ ] Add a second input element to the index.html CHECK
- [ ] Assign the second input element to a variable CHECK
- [ ] Add a third button (a switch button) to the index.html CHECK
- [ ] Assign the third button to a variable CHECK
...
switchButton.addEventListener("click", () => {
  let switchFirst = firstInput.value;
  let switchSecond = secondInput.value;
